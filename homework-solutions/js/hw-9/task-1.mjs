...
// 1
let keyWithFourChars = Object.keys(character).filter((elem) => elem.length === 4);


// 2
let stringValues = Object.values(character).filter((elem) => typeof (elem) === "string");
